...
export const mockLocations: Location[] = [
  ...
  // Additional diverse restaurants and specialty stores
  {
    id: "deli1",
    ...
    openNow: true,
    price: "$$",
    dietaryOptions: ["Deli", "Classic NY"],
    cuisine: "Jewish Deli",
  ...
  },
  {
    ...
    openNow: false,
    price: "$$",
    dietaryOptions: ["Fresh Baked", "Cookies"],
    cuisine: "Bakery",
    coordinates: { lat: 40.7794, lng: -73.9812 },
    images: ["/placeholder.svg", "/placeholder.svg"],
  },
  {
    id: "specialty1",
    ...
    openNow: true,
    price: "$$$",
    dietaryOptions: ["Gourmet", "Specialty", "Import"],
    cuisine: "Various",
    coordinates: { lat: 40.7247, lng: -73.9967 },
    images: ["/placeholder.svg", "/placeholder.svg"],
  },
  {
    id: "healthfood1",
    ...
    rating: 4.1,
    distance: "0.3 mi",
    address: "644 Broadway, New York, NY 10012",
    openNow: true,
    price: "$$",
    dietaryOptions: ["Healthy", "Organic", "Vegan"],
    cuisine: "Health Food",
    coordinates: { lat: 40.7270, lng: -73.9960 },
    images: ["/placeholder.svg", "/placeholder.svg"],
  }
];
